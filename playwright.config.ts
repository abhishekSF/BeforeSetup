...
export default defineConfig({
  ...
  use: { baseURL: "http://localhost:4780", trace: "retain-on-failure" },
  projects: [
  ...
  webServer: { command: "npm run start -- --port 4780", url: "http://localhost:4780", reuseExistingServer: !process.env.CI },
});
