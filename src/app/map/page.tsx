...
export const metadata: Metadata = {
  title: "Topic map",
  description:
    "An interactive map of the topics BeforeSetup covers. Data model, automation, code, UI, security, integration, DevOps, AI and agents, and architecture and strategy, with the connections between them.",
};
